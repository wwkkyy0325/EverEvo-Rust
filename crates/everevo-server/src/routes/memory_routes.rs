...
pub fn router() -> axum::Router<Arc<AppState>> {
    axum::Router::new()
        ...
        .route(
            ...
            axum::routing::post(trigger_consolidate),
        )
}
    ...
    let result = match phase {
        "light" => {
            ...
            if messages.is_empty() {
                ...
                match state
                    .dreaming_engine
                    .execute_light_with_messages("manual", &messages)
                    .await
                {
        ...
        "rem" => {
            match state
                .scheduler
                .trigger_phase(&ScheduledPhase::Rem, &state.dreaming_engine)
                .await
            {
        ...
        _ => {
            // "all" or any other value — run full pipeline
