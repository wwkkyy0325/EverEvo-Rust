...
pub(crate) fn system_deny_paths() -> Vec<String> {
    vec![
        ...
        // even from the shell tool. We protect these at the sandbox
        // chokepoint as defense-in-depth alongside write_file's own check.
        "**/crates/kernel/**".into(),
        "**/Cargo.toml".into(),
        "**/Cargo.lock".into(),
        "**/rust-toolchain.toml".into(),
        "**/target/release/everevo-server*".into(),
        "**/target/release/everevo.exe".into(),
        "**/target/release/everevo-kernel*".into(),
        "**/target/release/everevo_core*".into(),
        "**/target/release/everevo_mcp*".into(),
        "**/src-tauri/**".into(),
        "**/migrations/**".into(),
        "**/.git/**".into(),
        "**/rustfmt.toml".into(),
