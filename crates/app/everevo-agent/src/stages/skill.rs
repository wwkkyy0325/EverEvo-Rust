//! In-process Skill ContextStage for the context pipeline.
//!
//! Complemented by MCP stage plugin `plugin-stages-skill_stage` which exposes MCP tools.
//! This in-process version implements ContextStage for automatic skill list injection
