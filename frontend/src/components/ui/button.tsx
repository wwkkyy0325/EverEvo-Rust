...
const buttonVariants = cva(
  ...
  /* Bevel via inset box-shadow — zero layout impact. No visible border by default. */
  ...
  "active:shadow-[inset_0_1px_0_0_rgba(0,0,0,0.1),inset_0_-1px_0_0_rgba(255,255,255,0.08)] active:translate-y-px",
  {
    variants: {
      variant: {
        ...
        ghost: "shadow-none active:shadow-none active:translate-y-0 hover:bg-accent hover:text-accent-foreground",
        link: "shadow-none active:shadow-none active:translate-y-0 text-primary underline-offset-4 hover:underline",
      },
      size: {
